                    ...
                    <div class="p-6 bg-white text-center">
                        <form method="post" >
                            ...
                            <div class="mb-6">
                                ...
                                @enderror
                                <input type="submit" id="submit" name="submit" value="Deposit" class="w-1/12 mt-6 text-indigo-50 font-bold bg-indigo-600 py-3 rounded-md hover:bg-indigo-500 transition duration-300" ><br><br>
                            </div>
                        </form>
                        ...
                        <form method="post" action="/user/funds/withdraw">
                            ...
                            <div class="mb-6">
                                ...
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                                <input type="submit" id="submit" name="submit" value="Withdraw" class="w-1/12 mt-6 text-indigo-50 font-bold bg-indigo-600 py-3 rounded-md hover:bg-indigo-500 transition duration-300" ><br><br>
                            </div>
                        </form>
                    </div>
